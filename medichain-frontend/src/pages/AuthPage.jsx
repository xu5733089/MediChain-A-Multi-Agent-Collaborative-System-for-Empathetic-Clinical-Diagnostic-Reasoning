      ...
      >
        <div
          style={{
            ...
            height: 32,
            borderRadius: 9,
            background: "linear-gradient(135deg,#be3028,#d94038)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            color: "#fff",
            boxShadow: "0 3px 12px rgba(190,48,40,0.45)",
          }}
        >
          <svg
            width="18"
                    ...
                    style={{
                      ...
                      background:
                        mode === m.id
                          ...
                          : "transparent",
                      color:
                        mode === m.id ? lampColor : "rgba(240,228,210,0.35)",
            ...
            <div
              ...
              style={{
                ...
                background: success
                  ...
                  : "rgba(28,18,14,0.92)",
                border: success
                  ? "1px solid rgba(90,170,110,0.5)"
                  : "1px solid rgba(224,112,96,0.45)",
                boxShadow:
                  "0 12px 40px rgba(0,0,0,0.45), 0 0 0 1px rgba(0,0,0,0.2)",
