...
export default function InputPage({
  ...
  return (
    ...
    >
      ...
      <ParticleField
        count={14}
        style={{ position: "fixed", inset: 0, opacity: 0.7 }}
      />
      <IllustLeaf
        w={200}
        h={300}
      ...
      <IllustLeaf
        ...
        style={{
          ...
          bottom: "22%",
          right: "7%",
          animation: "float1 10s 3s ease-in-out infinite",
        ...
        {selectedPatient && (
          <div
            ...
            style={{
              ...
              border: "1.5px solid rgba(46,104,56,0.4)",
              borderRadius: 6,
              display: "flex",
              alignItems: "center",
              justifyContent: "space-between",
              boxShadow: "0 2px 14px rgba(46,104,56,0.14)",
            }}
          >
